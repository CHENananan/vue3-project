...
const handleToCheck = (selected, goods) => {
  cartStore.check(selected, goods)
}
...
<template>
  <div class="xtx-cart-page">
    <div class="container m-top-20">
        ...
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox
                  :model-value="cartSelectedTotalState"
                  @change="handleToCheckAll"
                />
              </th>
            ...
            <tr v-for="i in cartList" :key="i.id">
              <td>
                <el-checkbox
                  ...
                  @change="(selected) => handleToCheck(selected, i)"
                />
              </td>
              <td>
                <div class="goods">
      ...
      <div class="action">
        <div class="batch">
          共 {{ cartTotalCount }} 件商品，已选择
          {{ cartSelectedTotalCount }} 件，商品合计：
