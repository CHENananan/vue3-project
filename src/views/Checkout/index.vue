...
const handleToSwitchAddress = (item) => {
  activeAddress.value = item
}

const handleToChangeAddress = () => {
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @click="handleToShowDialog"
                >切换地址</el-button
              >
        ...
        <!-- 提交订单 -->
        <div class="submit">
          <el-button type="primary" size="large" @click="handleToCreateOrder"
            >提交订单</el-button
          >
        </div>
      </div>
  ...
  >
    <div class="addressWrapper">
      <div
        ...
        :key="item.id"
        @click="handleToSwitchAddress(item)"
      >
        <ul>
          <li>
    ...
    <template #footer>
      <span class="dialog-footer">
        <el-button @click="handleToCloseDialog">取消</el-button>
        <el-button @click="handleToChangeAddress" type="primary"
          >确定</el-button
        >
      </span>
    </template>
