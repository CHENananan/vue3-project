...
onMounted(() => {
    queryOrderList(params.value)
})

const handleToChangeTab = (type) => {
    params.value.orderState = type
    params.value.page = 1
    queryOrderList(params.value)
}

const handleToChangePage = (page) => {
...
<template>
    <div class="order-container">
        <el-tabs @tab-change="handleToChangeTab">
            <!-- tab切换 -->
            ...
            <div class="main-container">
                ...
                <div v-else>
                    ...
                    <div class="pagination-container">
                        <el-pagination :total="total" :page-size="params.pageSize" @current-change="handleToChangePage"
